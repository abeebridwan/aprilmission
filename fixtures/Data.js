...
export const sliderData = [
  {
    id: 1,
    src: '/01-small.webp',
    firstSrc: '/01-medium.webp',
    secondSrc: '/01-big.webp',
  ...
  },
  {
    id: 2,
    src: '/02-small.webp',
    firstSrc: '/02-medium.webp',
    secondSrc: '/02-big.webp',
  ...
  },
  {
    id: 3,
    src: '/03-small.webp',
    firstSrc: '/03-medium.webp',
    secondSrc: '/03-big.webp',
    title: "Let's be Kind for",
  ...
  },
  {
    id: 4,
    src: '/04-small.webp',
    firstSrc: '/04-medium.webp',
    secondSrc: '/04-big.webp',
    title: 'Share a Little for',
    SubTitle1: 'They just want to Learn',
    SubTitle2: 'Give them a chance by contributing',
...
export const modalImgData = [
  {
    id: 1,
    src: '/gallery/modal/1-small.webp',
    alt: 'a lady smilling with children in the school yard',
  },
  {
    id: 2,
    src: '/gallery/modal/2-small.webp',
    firstSrc: '/gallery/modal/2-medium.webp',
    secondSrc: '/gallery/modal/2-big.webp',
    alt: 'children in the school yard waving at the camera',
  },
  {
    id: 3,
    src: '/gallery/modal/3-small.webp',
    firstSrc: '/gallery/modal/3-medium.webp',
    secondSrc: '/gallery/modal/3-big.webp',
    alt: 'children in the school yard posing for the camera',
  },
  {
    id: 4,
    src: '/gallery/modal/4-small.webp',
    alt: 'a lady in black accompanying a child she rendered help to',
  },
  {
    id: 5,
    src: '/gallery/modal/5-small.webp',
    alt: 'a lady in black waiting for a child to come out of the of a house',
  },
  {
    id: 6,
    src: '/gallery/modal/6-small.webp',
    alt: 'two adults caring for a child-girl',
  },
  {
    id: 7,
    src: '/gallery/modal/7-small.webp',
    firstSrc: '/gallery/modal/7-medium.webp',
    secondSrc: '/gallery/modal/7-big.webp',
    alt: 'children in the school yard waiting for AprilMission Group',
  },
  {
    id: 8,
    src: '/gallery/modal/8-small.webp',
...
export const modalGalleryData = [
  {
    id: 1,
    src: '/gallery/small_01.webp',
    firstSrc: '/gallery/medium_01.webp',
    alt: 'a lady smilling with children in the school yard',
    index: 0,
  },
  {
    id: 2,
    src: '/gallery/small_02.webp',
    firstSrc: '/gallery/medium_02.webp',
    alt: 'children in the school yard waving at the camera',
    index: 1,
  },
  {
    id: 3,
    src: '/gallery/small_03.webp',
    firstSrc: '/gallery/medium_03.webp',
    alt: 'children in the school yard posing for the camera',
    index: 2,
  },
  {
    id: 4,
    src: '/gallery/small_04.webp',
    firstSrc: '/gallery/medium_04.webp',
    alt: 'a lady in black accompanying a child she rendered help to',
    index: 3,
  },
  {
    id: 5,
    src: '/gallery/small_05.webp',
    firstSrc: '/gallery/medium_05.webp',
    alt: 'a lady in black waiting for a child to come out of the of a house',
    index: 4,
  },
  {
    id: 6,
    src: '/gallery/small_06.webp',
    firstSrc: '/gallery/medium_06.webp',
    alt: 'two adults caring for a child-girl',
    index: 5,
  },
  {
    id: 7,
    src: '/gallery/small_07.webp',
    firstSrc: '/gallery/medium_07.webp',
    alt: 'children in the school yard waiting for AprilMission Group',
    index: 6,
  },
  {
    id: 8,
    src: '/gallery/small_08.webp',
    firstSrc: '/gallery/medium_08.webp',
    alt: 'AprilMission Chairman with a child he rendered help to',
    index: 7,
  },
];